...
mysql_query("SET NAMES UTF8");
	...
	$query = mysql_query("SELECT LAST_INSERT_ID() as id_cat FROM CATEGORIE");
	$result = mysql_fetch_assoc($query);
	$idsrc = $result['id_cat'];
	mysql_query("INSERT INTO SOURCE_FAV(login,id_source) VALUES(".$_SESSION['user'].",".$idsrc.")");
	$rss = lit_rss("http://fulltextrssfeed.com/".$_GET['source'], array("title", "link", "description", "pubDate"));
	$rss1 = lit_rss("http://".$_GET['source'],array("description","pubDate"));
	$j=1;
